...
class Estado : public BaseResponse, public JsonSerialize {
  private:
  std::string id;
  std::string sigla;
  std::string nome;
  ...
  Json::Value toJson() const override {
    ...
    jsonValue["nome"] = nome;
    jsonValue["sigla"] = sigla;
    jsonValue["regiao"] = regiao.toJson();
    return jsonValue;
  }
};
