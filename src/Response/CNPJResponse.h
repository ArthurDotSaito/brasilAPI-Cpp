...
public:
    ...
    std::string serialize() const {
        ...
        jsonCNPJ["nome_cidade_exterior"] = nome_cidade_exterior.has_value() ? nome_cidade_exterior.value() : Json::Value(Json::nullValue);
        ...
        jsonCNPJ["data_opcao_pelo_simples"] = data_opcao_pelo_simples.has_value() ? data_opcao_pelo_simples.value() : Json::Value(Json::nullValue);
        jsonCNPJ["data_exclusao_do_simples"] = data_exclusao_do_simples.has_value() ? data_exclusao_do_simples.value() : Json::Value(Json::nullValue);
        ...
        jsonCNPJ["data_situacao_especial"] = data_situacao_especial.has_value() ? data_situacao_especial.value() : Json::Value(Json::nullValue);
        ...
        Json::Value jsonQSAItem;
            ...
            if (qsaItem.cpf_representante_legal) jsonQSAItem["cpf_representante_legal"] = *qsaItem.cpf_representante_legal;
            if (qsaItem.nome_representante_legal) jsonQSAItem["nome_representante_legal"] = *qsaItem.nome_representante_legal;
            if (qsaItem.codigo_qualificacao_representante_legal) jsonQSAItem["codigo_qualificacao_representante_legal"] = *qsaItem.codigo_qualificacao_representante_legal;
